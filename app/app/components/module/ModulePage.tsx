...
export default function ModulePage({ params }: { params: { module: string } }) {
  ...
  useEffect(() => {
    const fetchModule = async () => {
      try {
        ...
        const foundModule = modules.find((m: ModuleState) => m.key === params.module)
        if (foundModule) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-green-400 p-4 font-mono">
      <div className="max-w-4xl mx-auto border border-green-500/30 rounded">
        {/* Terminal Header */}
        <div className=" bg-white dark:bg-black border-b border-green-500/30 p-2 flex items-center">
